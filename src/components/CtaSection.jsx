      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row justify-between items-center">
          ...
          <div className="py-12 xl:py-24 text-center xl:text-left">
            <h2 className="h2 mb-5" data-aos="fade-up" >
              {title}
            </h2>
          ...
          <div className="flex flex-col xl:flex-row gap-y-4 gap-x-[30px]">
            <button className="btn btn-secondary" data-aos="fade-up"
            data-aos-delay='300' >{btnText1}</button>
            <button className="btn btn-quaternary flex items-center gap-x-[20px] group"data-aos="fade-up"
            data-aos-delay='400'>
              {btnText2}
